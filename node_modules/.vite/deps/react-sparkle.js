  ...
  "node_modules/react-sparkle/dist/index.js"(exports, module) {
    (() => {
      ...
      var s, c = function(e2) {
        ...
        if (void 0 === t2 && (t2 = false), v.has(e2) && !t2) return v.get(e2);
        if (f(e2)) return v.set(e2, S), S;
        ...
        if (f(e2)) return 1 / 0;
        for (var t2 = 0, r2 = e2.parentNode; r2; ) t2 += 1, r2 = r2.parentNode;
        return t2;
      }, O = function() {
        var e2 = 1 / 0, t2 = [];
        ...
        for (var r2 = 0, n2 = t2; r2 < n2.length; r2++) (0, n2[r2])();
        return e2;
      }, A = function(e2) {
        ...
        for (var r2 = 0; r2 < e2.length; r2 += 1) if (e2[r2].target === t2) return r2;
        return -1;
      }, W = (function() {
        function e2() {
        }
        ...
        function e2(e3) {
          ...
          if ("function" != typeof e3) throw new TypeError("Failed to construct 'ResizeObserver': The callback provided as parameter 1 is not a function.");
          W.connect(this, e3);
        }
        return e2.prototype.observe = function(e3, t2) {
          if (0 === arguments.length) throw new TypeError("Failed to execute 'observe' on 'ResizeObserver': 1 argument required, but only 0 present.");
          if (!h(e3)) throw new TypeError("Failed to execute 'observe' on 'ResizeObserver': parameter 1 is not of type 'Element");
          W.observe(this, e3, t2);
        }, e2.prototype.unobserve = function(e3) {
          if (0 === arguments.length) throw new TypeError("Failed to execute 'unobserve' on 'ResizeObserver': 1 argument required, but only 0 present.");
          if (!h(e3)) throw new TypeError("Failed to execute 'unobserve' on 'ResizeObserver': parameter 1 is not of type 'Element");
          W.unobserve(this, e3);
      ...
      function V(e2, t2) {
        for (var r2 = 0; r2 < t2.length; r2++) {
          ...
          n2.enumerable = n2.enumerable || false, n2.configurable = true, "value" in n2 && (n2.writable = true), Object.defineProperty(e2, (void 0, o2 = (function(e3, t3) {
            if ("object" !== Z(e3) || null === e3) return e3;
            var r3 = e3[Symbol.toPrimitive];
            if (void 0 !== r3) {
              var n3 = r3.call(e3, "string");
              if ("object" !== Z(n3)) return n3;
      ...
      var _ = [0, 6, 13, 20], Q = { slowest: 50, slower: 20, slow: 12, normal: 7, fast: 4, faster: 2, fastest: 0 }, q = (function(e2) {
        ...
        return t2 = c2, r2 = [{ key: "componentDidMount", value: function() {
          ...
          if (!this.sparkleCanvas) return null;
          ...
          for (var e3 = this.props.count, t3 = 0; t3 < e3; t3 += 1) this.sparkles.push(this.createSparkle());
                  ...
                  if (null != r4) {
                    ...
                    try {
                      if (i4 = (r4 = r4.call(e5)).next, 0 === t5) {
                        ...
                        c4 = false;
                      } else for (; !(c4 = (n4 = i4.call(r4)).done) && (s4.push(n4.value), s4.length !== t5); c4 = true) ;
                    } catch (e6) {
                      u3 = true, o3 = e6;
                    } finally {
                      try {
                        if (!c4 && null != r4.return && (a4 = r4.return(), Object(a4) !== a4)) return;
                      } finally {
                        if (u3) throw o3;
                      }
                    }
          ...
          } else console.warn("No sparkles today :( The canvas did not render.");
