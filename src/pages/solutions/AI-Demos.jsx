...
const demos = [
  {
    ...
    description: (
      <>
        ...
        <br /><br />
        Learn more about Chatbot innovations &rarr;
      </>
    ),
    ...
    details: (
      <>
        ...
        <p>
          <a href="/contact" className="text-yellow-400 underline">Request a private chatbot demo</a>
        </p>
      </>
    )
  },
  {
    ...
    description: (
      <>
        ...
        <br /><br />
        Full Document AI platform demo &rarr;
      </>
    ),
    ...
    details: (
      <>
        ...
        <p>
          <a href="/contact" className="text-yellow-400 underline">Book a detailed walkthrough</a>
        </p>
      </>
    )
  },
  {
    ...
    description: (
      <>
        ...
        <br /><br />
        Explore the CRM AI platform &rarr;
      </>
    ),
    ...
    details: (
      <>
        ...
        <p>
          <a href="/contact" className="text-yellow-400 underline">Request a sales automation demo</a>
        </p>
      </>
    )
  },
  {
    ...
    description: (
      <>
        ...
        <br /><br />
        More on Private LLM Deployments &rarr;
      </>
    ),
    ...
    details: (
      <>
        ...
        <p>
          <a href="/contact" className="text-yellow-400 underline">Get private deployment access</a>
        </p>
      </>
    )
  }
...
const AIDemos = () => {
  ...
  // Handles click of "Learn more" description.
  const handleDescClick = () => {
    navigate(demos[activeDemo].route);
  };
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="mb-12 text-gray-300 max-w-3xl">
          ...
          <span className="text-sm text-gray-400">
            For custom demos or NDA engagements, 
            <a href="/contact" className="text-yellow-400 underline ml-1">contact us</a>.
          </span>
        </p>
        <div className="flex flex-wrap gap-4 mb-8">
          {demos.map((demo, idx) => (
            <button
              ...
              className={
                `px-5 py-2 rounded-xl font-medium text-base shadow transition 
                ${activeDemo === idx
                  ? "bg-yellow-400 text-black shadow-md"
                  : "bg-purple-900 text-purple-200 hover:bg-purple-700 hover:text-yellow-400"}`
              }
              style={{minWidth: 180}}
            >
              {demo.title}
        ...
        <div className="w-full bg-gray-900/95 px-10 py-10 rounded-2xl shadow-2xl border-2 border-purple-400/20 flex flex-col mb-10">
          <h2 className="text-3xl font-bold text-purple-400 mb-4">{demos[activeDemo].title}</h2>
          <div
            className="mb-4 text-yellow-400 cursor-pointer underline font-semibold"
          ...
          <hr className="my-6 border-purple-400/20" />
          <div className="text-gray-100">{demos[activeDemo].details}</div>
        </div>
      </div>
    </section>
  );
