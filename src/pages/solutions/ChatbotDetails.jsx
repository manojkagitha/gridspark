  ...
  return (
    <section className="min-h-screen w-full pt-20 sm:pt-24 pb-12 sm:pb-20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-6 sm:mb-8 text-center" data-aos="fade-up">
          Gridspark <span className="text-gradient-blue">AI Chatbot Solutions</span>
        </h1>

        <p className="mb-12 sm:mb-16 text-base sm:text-lg max-w-3xl mx-auto text-center text-gray-400 leading-relaxed px-4" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 mb-16 sm:mb-20">
          ...
          <div className="glass-panel p-6 sm:p-8 rounded-2xl border border-[var(--color-border)]" data-aos="fade-right">
            <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-white border-b border-[var(--color-border)] pb-3 sm:pb-4">
        ...
        <div className="mb-16 sm:mb-20" data-aos="fade-up">
          ...
          <div className="grid gap-4 sm:gap-6 max-w-4xl mx-auto">
            {faqs.map((faq, idx) => (
              ...
              >
                <h3 className="font-bold mb-2 sm:mb-3 text-base sm:text-lg text-white group-hover:text-[var(--color-primary)] transition-colors">
                  {faq.question}
                </h3>
        ...
        {/* Call To Action */}
        <div className="glass-panel p-6 sm:p-8 md:p-10 rounded-3xl text-center border border-[var(--color-border)] max-w-4xl mx-auto" data-aos="zoom-in">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-white">
            Want a Custom AI Chatbot Demo?
          </h2>
          <p className="mb-6 sm:mb-8 text-sm sm:text-base text-gray-300 max-w-2xl mx-auto">
          ...
          <a href="/contact" className="btn-primary text-base sm:text-lg px-6 sm:px-8 py-3 shadow-lg hover:shadow-xl hover:-translate-y-1 inline-block touch-manipulation active:scale-95">
