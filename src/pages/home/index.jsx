...
// Data
import { products, stats, recentActivities, quickLinks } from "../../data/homeData";
                  ...
                  <div className="mb-6 flex items-center gap-4">
                    <div className="w-16 h-16 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center overflow-hidden p-2 shadow-lg">
                      <ImageWithFallback
                        ...
                        fallback={<span className="text-2xl">{product.badge.split(' ')[0]}</span>}
                      />
                    </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-base text-gray-400 max-w-2xl mx-auto">
                Live performance indicators and operational benchmarks.
              </p>
            </div>
